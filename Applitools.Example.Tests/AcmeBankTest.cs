...
#pragma warning restore NUnit1032 // An IDisposable field/property should be Disposed in a TearDown method
    ...
    public static void SetUpConfigAndRunner()
    {
        ...
        Config.SetApiKey("EzNVQt9kul0nX08Wiauz102sRinyzlStq4FK101gU0dcqRg110");
    ...
    public void OpenBrowserAndEyes()
    {
        ...
        ILogHandler logHandler = new StdoutLogHandler(); // Example of a log handler


        // Create the Applitools Eyes object connected to the runner and set its configuration.
        Eyes = new Eyes((SeleniumEyesRunner)Runner);
        Eyes.SetConfiguration(Config);
        Eyes.SaveNewTests = true;

        Eyes.SetLogHandler(logHandler); // If you need to explicitly set the log handler
